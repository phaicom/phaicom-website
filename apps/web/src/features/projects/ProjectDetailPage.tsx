    ...
    <article className="mx-auto max-w-5xl">
      ...
      <motion.div
        ...
        className="prose prose-lg max-w-none prose-invert
          ...
          prose-h2:mt-12 prose-h2:mb-6 prose-h2:text-3xl prose-h2:first:mt-0
          ...
          prose-blockquote:py-1 prose-blockquote:not-italic prose-strong:font-semibold prose-strong:text-foreground prose-code:rounded-md prose-code:bg-accent prose-code:px-1.5 prose-code:py-0.5
          prose-code:text-sm prose-code:text-foreground prose-code:before:content-none prose-code:after:content-none prose-pre:rounded-xl
          prose-pre:border prose-pre:border-border prose-pre:bg-card prose-pre:shadow-lg
          ...
          prose-th:bg-accent prose-th:p-3
          prose-th:text-left prose-th:font-semibold prose-th:text-foreground prose-td:border-t
          prose-td:border-border prose-td:p-3 prose-td:text-muted-foreground prose-img:rounded-xl prose-img:border
          prose-img:border-border prose-img:shadow-lg prose-hr:my-12 prose-hr:border-border
        "
      >
