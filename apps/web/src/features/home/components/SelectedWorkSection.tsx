...
export default function SelectedWorkSection() {
  ...
  return (
    <SectionCard
      ...
      title="Systems built for real teams and real users."
      description={
        <Link
          to="/projects"
      ...
      <div className="border-t border-border">
        {projects.map((project, index) => (
          <Link
            ...
            className="group grid gap-5 border-b border-border py-7 sm:grid-cols-[3rem_1fr_12rem] sm:items-center lg:grid-cols-[4rem_1fr_22rem]"
          >
